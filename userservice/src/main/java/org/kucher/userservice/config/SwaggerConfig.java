package org.kucher.userservice.config;
...
public class SwaggerConfig {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("org.kucher.userservice"))
    ...
    private ApiInfo metaInfo() {
        return new ApiInfo(
                ...
                "1.0",
                "Terms of Service",
                new Contact("Pavel Kuchkovskii", "www.userservice.org/", "pavel.kuchkovskii@gmail.com"),
